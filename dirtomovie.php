...
<?php
    ...
    if($_GET["submit"]){
        $insert = "INSERT INTO MovieDirector VALUES (".$_GET["mid"].",".$_GET["did"].");";
        //echo $insert;
        if($rs = mysql_query($insert, $db_connection)){
            echo '<div class="alert alert-success alert-dismissable">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  Director successfully added to <a href="./movie.php?mid='.$mid.'">'.$currmovie->title.'</a>
              </div>';
        }
    ...
    <div class="panel-body">
        <form METHOD = "GET" ACTION = "./dirtomovie.php">
    ...
    echo '
        <div class="form-group">
            ...
            <select class="form-control" id="director" name="did">';
    foreach($directors as $director){
        echo '<option value='.$director->id.'>'.$director->first.' '.$director->last.'</option>
        ';
    }
    echo '
        </select>
